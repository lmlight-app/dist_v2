...
function Show-Usage {
    ...
    Write-Host ""
    Write-Host "リモート実行:"
    Write-Host '  irm https://raw.githubusercontent.com/lmlight-app/dist_v2/main/scripts/install-transcribe.ps1 | iex'
    Write-Host '  & ([scriptblock]::Create((irm https://raw.githubusercontent.com/lmlight-app/dist_v2/main/scripts/install-transcribe.ps1))) -ModelName small'
}
